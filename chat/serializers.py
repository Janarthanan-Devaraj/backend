...
class MessageSerializer(serializers.ModelSerializer):
    ...
    def get_receiver_data(self, obj):
        from accounts.serializers import UserProfileMessageSerializer
        return UserProfileMessageSerializer(obj.receiver.user_profile).data

    def get_sender_data(self, obj):
        from accounts.serializers import UserProfileMessageSerializer
        return UserProfileMessageSerializer(obj.sender.user_profile).data